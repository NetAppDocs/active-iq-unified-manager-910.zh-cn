...
[role="lead"]
您可以通过在Linux平台上下载并运行安装文件从Unified Manager 9.8或9.9升级到9.10。
...
* 在 Unified Manager 升级期间， MySQL Community Edition 会自动升级。如果系统上安装的 MySQL 版本早于 8.0.27 ，则 Unified Manager 升级过程会自动将 MySQL 升级到 8.0.27 。
